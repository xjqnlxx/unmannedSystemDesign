 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Jun 04 11:26:54 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME u
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void u_Outputs_wrapper(const int32_T *u0,
			real_T *y0);
/*====================*
 * S-function methods *
 *====================*/
